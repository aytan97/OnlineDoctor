    ...
    <div className="user-profile">
      <div className="user-info">
        <div className="round-image ">
          {!storedImage ? (
            <img src={avatarprof} alt="prof-avatar" />
          ) : (
            <img src={storedImage} alt="avatar-prof" />
          )}
        </div>
        {result?.token && user && (
      ...
      <div className="user-profile-detail">
        <Link
          className="text-decoration menu-item"
          to="/myProfile"
          onClick={onClose}
        >
          My Profile
      ...
      <div className="log-out menu-item" onClick={handleLogout}>
