...
const MyProfile = () => {
    ...
    const handleSubmitBtn = async (formResult: any) => {
        if (getMyProfile.data.userId) {
            ...
            if (getMyProfile.data.role === 'doctor') {
                ...
                dispatch(updateDoctor({ _id, ...formResult })).then(() => dispatch(getMe()))
                ...
                dispatch(updatePatient({ _id, ...formResult })).then(() => dispatch(getMe()))
                localStorage.removeItem('updatedProfileImage')
                localStorage.removeItem('updatedBlogImage')
    ...
    const handleDeleteAccount = () => {
        ...
        dispatch(deleteUser(id)).then(() => logoutAuth()).then(() => { navigate('/login'); location.reload(); })
    }
                    ...
                    <div className="my-profile">
                        <div className="profile-item">
                            <div className="select-photo">
                                    ...
                                    <div className="add-profile">
                                        <div className='form-group'>
                                            <Controller
                                                ...
                                                name="image"
                                                render={({ field }) => (
                                                    <div className="hide-image" onClick={handleImageUpload}>
                                                        Select photo
                                                        <input
                                                            {...field}
                                                            variant="filled"
                                ...
                                <div style={{ color: 'var(--input-color)' }}>{getMyProfile?.data.email}</div>
                            </div>
                        </div>
                        <div className="profile d-flex flex-column  container justify-space-between align-items-center">
                            <div className="d-flex flex-row  justify-space-between mb-3 media">
                                <div className='form-group mr-2'>
                                    ...
                                    />
                                    {errors.firstname && <p className="error mt-1">{errors.firstname.message}</p>}
                                </div>
                                <div className='form-group mr-2'>
                                    <Controller
                                        defaultValue=""
                                    ...
                                    />
                                    {errors.lastname && <p className="error mt-1">{errors.lastname.message}</p>}
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-row  justify-space-between mb-3 media">
                                <div className='form-group mr-2'>
                                    ...
                                    />
                                    {errors.phoneNumber && <p className="error mt-1">{errors.phoneNumber.message}</p>}
                                ...
                                <div className='form-group mr-2'>
                                    ...
                                    />
                                    {errors.age && <p className="error mt-1">{errors.age.message}</p>}
                                </div>


                            </div>

                            {getMyProfile?.data.role === 'doctor' && <div className="d-flex flex-row w-100  mb-2 media lang-tags">
                                <div className='form-group mr-2'>
                                    <Controller
                                        control={control}
                                        name="languageSkills"
                                    ...
                                    />
                                    {errors.languageSkills && <p className="error mt-1">{errors.languageSkills.message}</p>}
                            ...
                            <div className="d-flex flex-row  justify-space-between mb-3 media">
                                {getMyProfile?.data.role === 'doctor' && <div className='form-group mr-2'>
                                    <Controller
                                        defaultValue=""
                                        control={control}
                                    ...
                                    />
                                    {errors.currentWorkHospital && <p className="error mt-1">{errors.currentWorkHospital.message}</p>}
                                </div>}
                                ...
                                {getMyProfile?.data.role === 'doctor' && <div className='form-group mr-2'>
                                    ...
                                    />
                                    {errors.workExperience && <p className="error mt-1">{errors.workExperience.message}</p>}
                                </div>}
                            </div>

                            {getMyProfile?.data.role === 'doctor' && <div className='form-group media'>
                                <Controller
                                    defaultValue=""
                                    control={control}
                                    name="biography"
                                ...
                                />
                                {errors.biography && <p className="error">{errors.biography.message}</p>}
                            </div>
