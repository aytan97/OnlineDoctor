  ...
  return (
    <div className="mt-4 ">
      <p style={{ color: "var(--primary-color)" }}>
        <i>We would be happy to hear from you!</i>
      </p>
      <form
        onSubmit={handleSubmit(handleSubmitBtn)}
        className="mt-3 question-form"
      >
        <div className="frm-container d-flex flex-column">
          ...
          <Controller
            ...
            render={({ field }) => (
              <>
                <textarea {...field} className="bio" placeholder="..." />{" "}
              </>
            )}
          />
          {errors.questionText && (
            <p className="error">{errors.questionText.message}</p>
          )}
        </div>
