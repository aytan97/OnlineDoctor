...
const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiRGFydGhfQmFuZSIsImlzcyI6Imh0dHBzOi8vcHJvbnRvLmdldHN0cmVhbS5pbyIsInN1YiI6InVzZXIvRGFydGhfQmFuZSIsImlhdCI6MTcxNDg5Njc1NiwiZXhwIjoxNzE1NTAxNTYxfQ.x9k3j0I7vGxfXwANhTmFFmd8OdGn1cj9IFDVn1nNfiI';
...
//                         <div className="meeting-window"> </div>
//                         <div className="meeting-items">
//                             <div className="items">
//                                 <span><i className="fa-solid fa-microphone-slash"></i></span>
//                                 <span><i className="fa-solid fa-video"></i></span>
//                             </div>
//                         </div>
//                     </div>
//                     <div className="mt-4"><button>Join</button></div>
//                 </div>
