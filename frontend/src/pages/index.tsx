...
import CallApp, { VideoConference } from './VideoConferance'
            ...
            <Routes>
                {result.token && (
                    <>
                        ...
                        <Route path='/callDetails/:doctorid/:patientid' element={<CallApp />} />
                        ...
                        {user?.data?.role === 'doctor' && (
                            <>
                                ...
                                <Route path="/myavailabilities" element={<AvailabilityConfig />} />
                ...
                <Route path="/" element={<Home />} />
                <Route path="/login" element={<Auth role={role} toggleSwitch={toggleSwitch} />} />
                <Route path="/register" element={<Auth role={role} toggleSwitch={toggleSwitch} />} />
                <Route path="/otp-verification" element={<OTPVerification role={role} />} />
